...
cmd = entry:(crr / version / ost / ifm / dtm / ced / cph / bsb / knp / knq / rgb / ref / ply / error / any) newline? { return entry }
...
indent = newline '    '
comma = ','
number = number:[0-9\.]+ { return toNumber(number) }
...
comment = '!' comment:text newline { result.comment = comment }
